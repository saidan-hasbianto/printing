...
@Component({
  selector: 'app-joborder-new',
  templateUrl: './joborder-new.component.html',
  styleUrls: ['./joborder-new.component.scss']
})
export class JoborderNewComponent implements OnInit {
  ...
  ngOnInit() {    
    ...
    //         this.selected = parseInt(hsl.deliveryAddress);
